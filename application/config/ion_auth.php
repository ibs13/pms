 ...
 */
$config['site_title']                 = "Summit BIT";       // Site Title, example.com
$config['admin_email']                = "info@summit-bit.com"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<div class="alert alert-success"> <i class="fa fa-check-circle"></i> '; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissable"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> <i class="fa fa-warning"></i> ';		// Error message start delimiter
