...
if (!function_exists('create_pagination_front')) {
    /**
     * The Pagination helper cuts out some of the bumf of normal pagination
     *
     * @param string $uri The current URI.
     ...
     * @see Pagination::create_links()
     */
    function create_pagination_front($uri, $total_rows, $limit = null, $uri_segment = 3, $full_tag_wrap = true) {
        $ci = & get_instance();
        $ci->load->library('pagination');
        $current_page = $ci->uri->segment($uri_segment, 0);
        $suffix = $ci->config->item('url_suffix');
        ...
        $ci->pagination->initialize(array(
            ...
            // 'use_page_numbers'  => true,
            'reuse_query_string'=> true,
            'full_tag_open'     => '<div class="pagination center">',
            'full_tag_close'    => '</div>',
            'first_tag_open'    => '',
            'first_tag_close'   => '',
            'last_tag_open'     => '',
            ...
            'next_link'         => '',
            'last_link'         => '',
            'prev_tag_open'     => '<a href="#" class="navlinks"> &lt; Previous',
            'prev_tag_close'    => '</a>',
            'next_tag_open'     => '<a href="#" class="navlinks">Next >',
            'next_tag_close'    => '</a>',
            'cur_tag_open'      => '',
            'cur_tag_close'     => '',
            'num_tag_open'      => '',
